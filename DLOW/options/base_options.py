...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # 训练时保留此参数，测试时修改为'single'，即测试时取注释掉的这一行
        ...
        #                          help='chooses how datasets are loaded. [unaligned | aligned | single]') # test时修改
        # 训练时保留此参数，测试时修改为'test'，即测试时取注释掉的这一行
        self.parser.add_argument('--model', type=str, default='cycle_gan',
                                 help='chooses which model to use. cycle_gan, pix2pix, test')
        # self.parser.add_argument('--model', type=str, default='test',
        #                          help='chooses which model to use. cycle_gan, pix2pix, test') # test时修改
        ...
        # 训练时保留此参数，测试时修改为'scale_width'，即测试时取注释掉的这一行
    ...
    def parse(self):
        ...
        args = vars(opt)  # 返回对象object的属性和属性值的字典对象
